...
class LM393:
    ...
    def start(self):
        ...
        GPIO.add_event_callback(GPIOManager.LM393_R, callback=self.right_sensor_callback, bouncetime=20)
        GPIO.add_event_callback(GPIOManager.LM393_L, callback=self.left_sensor_callback, bouncetime=20)
